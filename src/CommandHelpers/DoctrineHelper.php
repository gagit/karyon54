...
class DoctrineHelper
{
     ...
     */
    public function __construct(string $entityNamespace='App\Entity', $registry = null,
                                bool $attributeMappingSupport = false, array $annotatedPrefixes = null)
    {
        $this->entityNamespace = trim($entityNamespace, '\\');
        //$this->phpCompatUtil = $phpCompatUtil;  PhpCompatUtil $phpCompatUtil,
